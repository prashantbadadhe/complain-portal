...
import com.radixile.panvel.domain.Location;
import com.radixile.panvel.repository.LocationRepository;
import com.radixile.panvel.service.LocationService;
...
import static com.radixile.panvel.web.rest.TestUtil.createFormattingConversionService;
...
public class LocationResourceIntTest {
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getAddressLineOne()).isEqualTo(DEFAULT_ADDRESS_LINE_ONE);
        assertThat(testLocation.getAddressLineTwo()).isEqualTo(DEFAULT_ADDRESS_LINE_TWO);
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getAddressLineOne()).isEqualTo(UPDATED_ADDRESS_LINE_ONE);
        assertThat(testLocation.getAddressLineTwo()).isEqualTo(UPDATED_ADDRESS_LINE_TWO);
